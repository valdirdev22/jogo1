...
const imagens = ['./img/d1.png', './img/d2.jpg', 
'./img/d3.jpg', './img/d4.jpg', './img/d5.jpg', 
'./img/d6.jpg'];
 
for (let i = 1; i <= 8; i++) imagens.push(`../RAFA/id/${i}/100`);
 
let fundo = `./img/capa1.jpg`;
...
onload = () => {
    ...
    document.body.style.backgroundImage = "url('./img/f2.jpg')";
};
...
const inicioJogo = () => {
  ...
  // Reinicia o estado do jogos
    ...
    document.body.style.backgroundImage = "url('./img/f3.jpg')";
...
temCartaVirada = false;
 ...
 if(pontos == 6) {
    ...
    document.querySelector('.titulo').textContent ='Parabéns Rafael!';
